 ...
 */
final class Version20230614112600 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE autopart (autopart_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', car_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', warehouse_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', title VARCHAR(255) NOT NULL, description VARCHAR(2000) NOT NULL, INDEX IDX_24A98051C3C6F69F (car_id), INDEX IDX_24A980515080ECDE (warehouse_id), PRIMARY KEY(autopart_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE warehouse (warehouse_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', address VARCHAR(255) NOT NULL, opening_hours VARCHAR(255) NOT NULL, PRIMARY KEY(warehouse_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
